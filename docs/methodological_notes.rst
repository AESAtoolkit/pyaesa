...
This page provides the methodological notes and citation guide shipped with the
...
methodological basis for ``pyaesa``, including the allocation methods included
in the package.
...
For data source citations, see the recommended citation guide:

* :download:`Recommended citations <../methodological_notes/recommended_citations.txt>`
...
* :doc:`tutorials/study_objectives/1_functional_units_and_allocation_methods.md <tutorials/study_objectives/1_functional_units_and_allocation_methods>`:
  short guide summarizing Appendix B regarding the selection of functional units and allocation methods in ``pyaesa``.
