...
The documentation follows the repository tutorial layout: core prerequisite
notebooks, study objective notebooks, and optional workflow notebooks.

.. toctree::
   :maxdepth: 2

   tutorials/core_prerequisites/index
