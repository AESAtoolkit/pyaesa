"""Metadata and cleanup ownership for aCC uncertainty figures."""
...
def clear_uncertainty_figure_scope(*, paths: ACCUncertaintyRunPaths) -> None:
    """Delete persisted uncertainty aCC figure files recorded in the manifest."""
...
def write_run_figure_paths(
    *,
    ...
    """Persist aCC uncertainty figure paths in the run manifest artifacts."""
    write_manifest_figure_paths(
