...
def _readme_text(
    *,
    ...
    lines = [
        ...
        "",
        "Artifacts",
        "- row_identity: public AR6 CC selected trajectory rows.",
        *public_run_artifact_readme_lines(run_name="cc_runs"),
        ...
        "- post_study_period_row_identity, post_study_period_cc_runs,",
        ...
        "cc_runs.public_row_id to row_identity.public_row_id to read",
